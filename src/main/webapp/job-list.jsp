            ...
            <div class="container">
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="tab-content">
						...
						ArrayList<Job> jobs = jobService.getAllJobs();
						%>
						    ...
						    <div class="job-item p-4 mb-4">
						        <div class="row g-4">
						            <div class="col-sm-12 col-md-8 d-flex align-items-center">
						                ...
						                <img class="flex-shrink-0 img-fluid border rounded" src="img/${}" alt="" style="width: 80px; height: 80px;">
						            ...
						            <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
						                <div class="d-flex mb-3">
						                    ...
						                    <a class="btn btn-primary" href="applyJob?jobId=${job.ID}">Apply Now</a>
						                </div>
						                <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>Date Line: ${job.publishedDate}</small>
						            </div>
						        </div>
						    </div>
						</c:forEach>
