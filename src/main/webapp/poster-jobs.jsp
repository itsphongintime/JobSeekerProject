    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Listed Jobs</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Your Posted Jobs</li>
                    </ol>
                </nav>
            </div>
        </div>
		...
		<div class="container-xxl py-5">
			<div class="container">
				<h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Your
					Posted Jobs</h1>
				<div class="tab-class text-center wow fadeInUp"
					...
					<div class="tab-pane fade show p-0 active">
								...
								<div class="row g-4">
									...
									<div
										...
										<div class="d-flex mb-3">
											<a class="btn btn-primary" href="JobDetail?jobId=${job.id}">Edit
												Details</a>
										</div>
						...
						<a class="btn btn-primary py-3 px-5" href="JobRegister">Add a job listing</a>
					</div>
				</div>
			</div>
		</div>
