                ...
                <div class="row gy-5 gx-4">
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center mb-5">
                            <img class="flex-shrink-0 img-fluid border rounded" src="img/${company.logo}" alt="" style="width: 80px; height: 80px;">
                        ...
                        <div class="mb-5">
                            ...
                            <c:forEach items="${responsibility}" var="responsibility">
                            	<li><i class="fa fa-angle-right text-primary me-2"></i>${responsibility.desc}</li>
                            </c:forEach>
                            ...
                            <c:forEach items="${qualification}" var="qualification">
                            	<li><i class="fa fa-angle-right text-primary me-2"></i>${qualification.desc}</li>
                            </c:forEach>
                            
                            </ul>
                        </div>
        				
        				<c:if test="${sessionScope.user.type == 'Seeker'}">
	                        <div class="">
                    ...
                    <div class="col-lg-4">
                        <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                            ...
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Published On: ${job.publishedDate}</p>
